...
with col1:
    ...
    st.page_link("pages/Machine_Learning.py", label="ดูรายละเอียดโมเดล ML", icon="📂")
with col2:
    st.success("ทดลองใช้งานระบบทำนายผลจริง")
    # ตรวจสอบชื่อไฟล์ Machine_Learning_Models.py
    st.page_link("pages/Machine_Learning_Models.py", label="ใช้งานโมเดล ML", icon="🚀")
...
with col3:
    ...
    st.page_link("pages/Neural_networks.py", label="ดูรายละเอียดโมเดล NN", icon="📂")
with col4:
    st.warning("ทดลองจำลองข้อมูลผู้โดยสารเพื่อทำนายผล")
    # ตรวจสอบชื่อไฟล์ Neural_networks_model.py
    st.page_link("pages/Neural_networks_model.py", label="ใช้งานโมเดล NN", icon="🚀")

st.divider()
st.caption("© 2026 Intelligent System Project")