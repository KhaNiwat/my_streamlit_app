...
st.write("ชุดข้อมูลที่ใช้คือ `heart_dataset_500_BY_chatgpt.csv` มีจำนวน 500 records โดยมีตัวแปร (Features) ที่เกี่ยวข้องกับสุขภาพและผลการตรวจร่างกาย ดังนี้:")
...
st.write("Scikit-learn Documentation: sklearn.ensemble.VotingClassifier, LogisticRegression, RandomForestClassifier, GradientBoostingClassifier")